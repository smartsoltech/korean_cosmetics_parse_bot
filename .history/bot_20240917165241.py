...
def main() -> None:
    ...
    application.add_handler(CommandHandler(filters.Regex('заказ'), command_logic.start_order))
    ...
    application.add_handler(MessageHandler(filters.Regex('Сформировать ТН'), order_manager.generate_shipping_file))
