...
class Parser:
    ...
    def parse_product_info(self):
        ...
        try:
            ...
            try:
                print("looking for final price")
                final_price_element = self.driver.find_element(By.CSS_SELECTOR, ".prod-coupon-price .total-price strong")
                print(f"found final price element: {final_price_element}")
                final_price = final_price_element.text
                print(f"final price text: {final_price}")
            ...
            try:
                print("looking for original price")
                original_price_element = self.driver.find_element(By.CSS_SELECTOR, ".prod-origin-price .origin-price")
                print(f"found original price element: {original_price_element}")
